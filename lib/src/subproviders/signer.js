...
var SignerSubprovider = /** @class */ (function (_super) {
     ...
     */
    function SignerSubprovider(provider) {
    ...
    SignerSubprovider.prototype.handleRequest = function (payload, next, end) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, nodeVersion, err_1, accounts, err_2, _b, txParams, txData, txHash, err_3, _c, address, message, signature, err_4;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 9:
                        _b = __read(payload.params, 1), txParams = _b[0];
                        _d.label = 10;
                    case 10:
                    ...
                    case 14:
                        _c = __read(payload.params, 2), address = _c[0], message = _c[1];
                        _d.label = 15;
                    case 15:
